...
class ProfileController extends Controller
{
    ...
    public function updateUser(Request $request, User $user)
    {
        ...
        return redirect()->route('users.index', $user)->with('success', __('messages.user_updated_successfully'));
    }
    ...
    public function resetPassword(Request $request)
    {
        ...
        return redirect()->route('profile.showResetPasswordForm')->with('success', __('messages.password_reset_successfully'));
    }
    ...
    public function logout(Request $request)
    {
        ...
        return redirect('/login')->with('success', __('messages.logged_out_successfully'));
    }
