    ...
    <div class="layout-px-spacing">
        <div class="row layout-top-spacing">
            <div class="page-title">
                <h3>{{ __('navigation.create_inspection_transaction') }}</h3>
                ...
                <form method="POST" action="{{ route('inspection-transactions.store') }}">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <button class="btn btn-outline-secondary" type="button" id="validate_barcode">
                                <i class="fas fa-search"></i> {{ __('buttons.validate') }}
                            </button>
                        </div>
                    ...
                    <div class="form-group mb-4">
                        <label for="observation_select">{{ __('forms.observations') }}:</label>
                    ...
                    <a href="{{ route('inspection-transactions.index') }}" class="btn btn-secondary">{{ __('buttons.cancel') }}</a>
                </form>
            </div>
        </div>
    </div>
