    ...
    <div class="layout-px-spacing">
        <div class="row layout-top-spacing">
            <div class="page-title">
                <h3>{{ __('navigation.edit_inspection_transaction') }}</h3>
            </div>
                ...
                <div class="widget-content widget-content-area br-8">
                    ...
                    <form method="POST" action="{{ route('inspection-transactions.update', $inspectionTransaction) }}">
                        ...
                        <div class="form-group mb-4">
                            <label for="barcode">{{ __('forms.barcode') }}:</label>
                            <div class="input-group">
                                ...
                                <button class="btn btn-outline-secondary" type="button" id="validate_barcode">
                                    <i class="fas fa-search"></i> {{ __('forms.validate') }}
                                </button>
                            </div>
                            <small class="form-text text-muted">{{ __('forms.enter_barcode_and_validate') }}</small>
                        ...
                        <div class="form-group mb-4">
                            <label>{{ __('forms.tire_type') }}:</label>
                        ...
                        <div class="form-group mb-4">
                            <label for="machine">{{ __('forms.machine') }}:</label>
                        ...
                        <div class="form-group mb-4">
                            <label for="operator_name">{{ __('forms.operator_name') }}:</label>
                        ...
                        <div class="form-group mb-4">
                            <label for="operator_code">{{ __('forms.operator_code') }}:</label>
                        ...
                        <div class="form-group mb-4">
                            <label>{{ __('forms.observations') }}:</label>
                            <div class="input-group mb-3">
                                <select id="observation_select" class="form-control">
                                    <option value="">{{ __('forms.select_observation') }}</option>
                            ...
                            <div id="observations_error" class="invalid-feedback d-none">
                                {{ __('forms.observation_already_added') }}
                            </div>
                            @error('observations')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="form-group mb-4" id="decision_row" style="display: none;">
                            ...
                            <div class="d-flex gap-3">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="decision_repair">{{ __('forms.repair') }}</label>
                                </div>
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="decision_scrap">{{ __('forms.scrap') }}</label>
                                </div>
                            </div>
                            @error('decision')
                                <div class="text-danger">{{ $message }}</div>
                        ...
                        <div class="form-group mb-4">
                            <a href="{{ route('inspection-transactions.index') }}" class="btn btn-secondary">{{ __('buttons.back_to_inspection_transactions') }}</a>
                            <button type="submit" class="btn btn-primary">{{ __('buttons.update_inspection_transaction') }}</button>
                        </div>
                    </form>
                </div>
            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        addObservationBtn.addEventListener('click', function() {
            ...
            if (!observationId) {
                showError('{{ __('forms.select_observation') }}');
                return;
            }
            if (isObservationAdded(observationId)) {
                showError('{{ __('forms.observation_already_added') }}');
                return;
            }
