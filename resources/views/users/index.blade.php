        ...
        <div class="middle-content container-xxl p-0">
            ...
            <div class="page-meta">
                <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">{{ __('navigation.users') }}</a></li>
                    </ol>
                </nav>
            </div>
            <!-- /BREADCRUMB -->
                        ...
                        <form method="GET" action="{{ route('users.index') }}" class="mb-3">
                            <div class="row">
                                <div class="col-md-4 col-12 filter-column">
                                    <input type="text" name="name" class="form-control" placeholder="{{ __('forms.enter_name') }}"
                                        value="{{ request('name') }}">
                                </div>
