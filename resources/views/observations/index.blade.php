        ...
        <div class="middle-content container-xxl p-0">
            ...
            <div class="page-meta">
                <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">{{ __('navigation.observations') }}</a></li>
                    </ol>
                </nav>
            </div>
            <!-- /BREADCRUMB -->
            ...
            <div class="row layout-top-spacing">
                ...
                <x-add-button model="observations" name="observations" displayName="observation" />
                    ...
                    <div class="widget-content widget-content-area br-8">
                            ...
                            <div class="row align-items-end">
                                ...
                                <div class="col-md-4 col-12 filter-column">
                                    <input type="text" id="filter-name-ar" name="name_ar" class="form-control"
                                        placeholder="{{ __('navigation.filter_by_arabic_name') }}"
                                        value="{{ request('name_ar') }}">
                                </div>
                                <div class="col-md-4 col-12 filter-column">
                                    <input type="text" id="filter-name-en" name="name_en" class="form-control"
                                        placeholder="{{ __('navigation.filter_by_english_name') }}"
                        ...
                        <table id="zero-config" class="table dt-table-hover" style="width:100%">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>{{ __('navigation.name_arabic') }}</th>
                                    <th>{{ __('navigation.name_english') }}</th>
                                    <th class="text-center">{{ __('navigation.actions') }}</th>
                                </tr>
                            </thead>
                            <tbody>
    ...
    <script>
        $('#zero-config').DataTable({
            ...
            "oLanguage": {
                ...
                "sInfo": "{{ __('pagination.showing_page') }} _PAGE_ {{ __('pagination.of') }} _PAGES_",
                "sLengthMenu": "{{ __('pagination.results') }} :  _MENU_",
            },
            "stripeClasses": [],
