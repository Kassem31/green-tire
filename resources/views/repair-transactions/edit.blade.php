    ...
    <div class="layout-px-spacing">
        <div class="row layout-top-spacing">
            <div class="page-title">
                <h3>{{ __('navigation.edit_repair_transaction') }}</h3>
            </div>
                ...
                <div class="widget-content widget-content-area br-8">
                    ...
                    <form method="POST" action="{{ route('repair-transactions.update', $repairTransaction) }}" id="repair-form">
                        ...
                        <div class="form-group mb-4">
                            <label>{{ __('forms.inspection_information') }}:</label>
                            <div class="row">
                                <div class="col-md-4">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <button type="submit" class="btn btn-primary">{{ __('buttons.update_repair_transaction') }}</button>
                        </div>
                    </form>
                </div>
            </div>
