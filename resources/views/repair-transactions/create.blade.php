    ...
    <div class="layout-px-spacing">
        <div class="row layout-top-spacing">
            <div class="page-title">
                <h3>{{ __('navigation.create_repair_transaction') }}</h3>
            </div>
                ...
                <div class="widget-content widget-content-area br-8">
                    ...
                    <form method="POST" action="{{ route('repair-transactions.store') }}" id="repair-form">
                        ...
                        <div class="form-group mb-4">
                            <h5>{{ __('forms.inspection_transaction_details') }}:</h5>
                            <div class="row mb-3">
                                <div class="col-md-4">
                                    <p><strong>{{ __('forms.barcode') }}:</strong> {{ $inspectionTransaction->barcode }}</p>
                                </div>
                                <div class="col-md-4">
                                    <p><strong>{{ __('forms.tire_type') }}:</strong> {{ $inspectionTransaction->tireType->name_en }}</p>
                                </div>
                                <div class="col-md-4">
                                    <p><strong>{{ __('forms.decision') }}:</strong> {{ $inspectionTransaction->decision }}</p>
                                </div>
                            </div>
                        ...
                        <div class="form-group mb-4" id="repair-steps-section">
                            <label for="repair_step">{{ __('forms.repair_steps') }}:</label>
                            <div class="row mb-3 align-items-end">
                                <div class="col-md-10">
                                    <select class="form-control" id="repair_step">
                                        <option value="">{{ __('forms.select_repair_step') }}</option>
                        ...
                        <!-- Final Decision -->
                        <div class="form-group mb-4">
                            <label>{{ __('forms.final_decision') }}:</label>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <button type="submit" class="btn btn-primary">{{ __('buttons.create_repair_transaction') }}</button>
                        </div>
                    </form>
                </div>
            </div>
