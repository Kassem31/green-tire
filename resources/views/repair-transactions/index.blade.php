        ...
        <div class="middle-content container-xxl p-0">
            ...
            <div class="row layout-top-spacing">
                <div class="page-title">
                    <h3>{{ __('navigation.repair_transactions') }}</h3>
                </div>
                        ...
                        <div class="table-responsive">
                            <table id="zero-config" class="table dt-table-hover" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>{{ __('forms.id') }}</th>
                                        <th>{{ __('forms.inspection_barcode') }}</th>
                                        <th>{{ __('forms.tire_type') }}</th>
                                        <th>{{ __('forms.decision') }}</th>
                                        <th>{{ __('forms.repair_steps') }}</th>
                                ...
                                <tbody>
                                    @forelse ($repairTransactions as $transaction)
                                        <tr>
                                            <td data-th="{{ __('forms.id') }}">{{ $transaction->id }}</td>
                                            <td data-th="{{ __('forms.inspection_barcode') }}">
                                            ...
                                            <td data-th="{{ __('forms.repair_steps') }}">
                                                {{ $transaction->repairSteps->count() }}</td>
                                            <td data-th="{{ __('forms.created_at') }}">
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="7" class="text-center">
                                                {{ __('messages.no_repair_transactions_found') }}</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
