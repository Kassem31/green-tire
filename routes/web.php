...
// Observations test route (with sample data)
Route::get('/observations-test', function () {
    $observations = collect([
        (object)['id' => 1, 'name_ar' => 'تشقق في الإطار', 'name_en' => 'Tire Crack'],
        (object)['id' => 2, 'name_ar' => 'تآكل غير منتظم', 'name_en' => 'Irregular Wear'],
        (object)['id' => 3, 'name_ar' => 'انتفاخ في الجانب', 'name_en' => 'Sidewall Bulge'],
    ]);
